...
urlpatterns = [
    ...
    url(r'^assembly/(?P<pk>[0-9]+)/delete/$', views.AssemblyDeleteView.as_view(), name="assembly-delete"),
    ...
    url(r'^verdict/(?P<pk>[0-9]+)/delete/$', views.VerdictDeleteView.as_view(), name="verdict-delete"),
